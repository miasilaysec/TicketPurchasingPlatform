...
<body>
    <div class="main-container">
        <h2 style="text-align: center;">Satın Alınan Biletler</h2>
            ...
            <?php foreach ($biletler as $bilet): ?>
                <div class="ticket-card">
                    <div class="ticket-info">
                        <h4><?php echo htmlspecialchars($bilet['departure_city']); ?> -> <?php echo htmlspecialchars($bilet['arrival_city']); ?></h4>
                        <p>
                        ...
                        <p>
                            <strong>Koltuk No:</strong> <?php echo $bilet['seat_number']; ?> | 
                            <strong>Ödenen Tutar:</strong> <?php echo $bilet['purchase_price']; ?> TL
                        </p>
                    </div>
                    <div class="ticket-actions">
                        <a href="bilet_pdf.php?ticket_id=<?php echo $bilet['ticket_id']; ?>" target="_blank">
                            <button style="background-color: #ffc107; color: black;">PDF İndir</button>
                        </a>
                        <form action="bilet_iptal.php" method="POST" style="display: inline;" onsubmit="return confirm('Bu bileti iptal etmek istediğinizden emin misiniz? Bu işlem geri alınamaz.');">
        ...
        <?php else: ?>
            <div class="no-tickets">
                ...
                <a href="index.php"><button>Hemen Bilet Al</button></a>
            </div>
        <?php endif; ?>
